      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-2">Gihani Wijekoon</h3>
            <p className="text-gray-300">Software Engineer | IT Undergraduate</p>
            <p className="text-gray-400 text-sm mt-4">
              &copy; {currentYear} Gihani Wijekoon. All rights reserved.
            </p>
          </div>
          ...
          <div className="mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-purple-400 transition">Projects</a>
              </li>
              <li>
